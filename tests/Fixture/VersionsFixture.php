...
class VersionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'archive_folder_present' => ['type' => 'string', 'length' => 3, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'archive_folder_path' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'project_id' => 1,
            'archive_folder_present' => 'L',
            'archive_folder_path' => 'Lorem ipsum dolor sit amet',
            'created_on' => '2016-12-23 03:36:24'
        ],
    ];
}
